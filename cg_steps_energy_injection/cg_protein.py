...
class CG22_Protein(Molecule):
    ...
    def cg_file_reader(cls, cgfile, AA_num_threshold=3000):
        ...
        # this is additionally added to handle WT-MT-based PPI predictions
        if pdb in ['wt', 'mt']:
            pdb = os.path.normpath(cgfile).split(os.sep)[-2]
    ...
    def cg_feature_generator(cls, cg_info, cg_file):
        ...
        # print(pdb_name) # wt
        # this is additionally added to handle WT-MT-based PPI predictions
        if pdb_name in ['wt', 'mt']:
            pdb_name = os.path.normpath(cg_file).split(os.sep)[-2]
        # print(pdb_name) # 1AK4__1

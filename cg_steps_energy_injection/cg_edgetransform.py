...
class AdvSpatialEdge(nn.Module, core.Configurable):
    ...
    def forward(self, graph):
        ...
        # print(edge_list, edge_list.size()) # torch.Size([1364, 2]) (based on above setting)
        ...
        # for example: one edge: [419, 183] (end node indices), graph.num_nodes.cumsum(0): tensor([183, 263, 413, 503]), nodes 419 and 183 should not be connected theortically

...
class GeometryAwareRelationalGraphNeuralNetwork(nn.Module, core.Configurable):
    ...
    def forward(self, graph, input, all_loss=None, metric=None):
        ...
        # graph in MSP: PackedProtein(batch_size=8, num_atoms=[2054, 2054, 3190, 3265, 3244, 1835, 2054, 2054],
        # num_bonds=[33064, 33064, 49092, 52182, 51380, 29014, 33064, 33064], num_residues=[274, 274, 400, 400, 400, 227, 274, 274], device='cuda:0')

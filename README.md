...
(whether to use the pre-trained CG graph encoder checkpoint can be directly specified by the 'model_checkpoint' arugment in above yaml file, if not, excuating training-from-scratch)

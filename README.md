...
1. No matter for the pre-training phase or the downstream prediction phase, the framework requires the geometric parameters generated by MARTINI22 or MARTINI3 for each sample as the input. 

...
from cg_maml_steps.cg_protein import CG22_PackedProtein
...
class CG22_GraphConstruction(nn.Module, core.Configurable):
    ...
    def apply_edge_layer(self, graph):
        ...
        # print(isinstance(graph, data.CG22_PackedProtein), isinstance(graph, CG22_PackedProtein), isinstance(graph, data.PackedMolecule))
        # False, True, True
